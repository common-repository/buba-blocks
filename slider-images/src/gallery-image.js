    ...
    render() {
        ...
        return (
            <figure className={ className }>
                ...
                { isEditing && (
                    <MediaPlaceholder
                        labels={ { title: __( 'Edit slider image', 'buba-blocks' ) } }
                        icon={ imageIcon }
                ...
                <ButtonGroup className="block-library-gallery-item__inline-menu is-left">
                    <Button
                        ...
                        label={ __( 'Move image backward', 'buba-blocks' ) }
                    ...
                    <Button
                        ...
                        label={ __( 'Move image forward', 'buba-blocks' ) }
                ...
                <ButtonGroup className="block-library-gallery-item__inline-menu is-right">
                    <Button
                        icon={ replace }
                        onClick={ this.onEdit }
                        label={ __( 'Replace image', 'buba-blocks' ) }
                        disabled={ ! isSelected }
                    />
                    <Button
                        icon={ close }
                        onClick={ onRemove }
                        label={ __( 'Remove image', 'buba-blocks' ) }
                        disabled={ ! isSelected }
                    />
                </ButtonGroup>
                { ! isEditing && ( isSelected || caption ) && (
                    <RichText
                        tagName="figcaption"
                        placeholder={
                            isSelected ? __( 'Write caption…', 'buba-blocks' ) : null
                        }
                        value={ caption }
